        ...
        internal static string GetPipelineName()
        {
            switch (RenderPipelineUtility.GetActivePipeline())
            {
                case RenderPipelineUtility.PipelineKind.Universal:
                    return "Universal (URP)";
                case RenderPipelineUtility.PipelineKind.HighDefinition:
                    return "High Definition (HDRP)";
                case RenderPipelineUtility.PipelineKind.BuiltIn:
                    return "Built-in";
                case RenderPipelineUtility.PipelineKind.Custom:
                    return "Custom";
                default:
                    return "Unknown";
            }
        ...
        internal static object ReadSerializedValue(SerializedProperty prop)
        {
            switch (prop.propertyType)
            {
                ...
                case SerializedPropertyType.Integer:
                    return prop.type == "long" ? prop.longValue : (object)prop.intValue;
